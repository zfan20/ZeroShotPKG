...
import dgl
from heterognnmodels import RGCN
import torch.nn.functional as F

class RGCNLinkPredict(nn.Module):
    def __init__(self, in_dim, num_rels, h_dim=128, out_dim=128, num_bases=8, dropout=0.2, reg_param=0.01):
        super(RGCNLinkPredict, self).__init__()
        self.rgcn = RGCN(in_dim, h_dim, out_dim, num_rels, regularizer="bdd",
                         num_bases=num_bases, dropout=dropout, self_loop=True, ns_mode=True)
